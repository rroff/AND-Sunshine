...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("Database is not opened", db.isOpen());
        ...
        assertTrue("Error: Failed to find inserted record", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Inserted data does not match expected values",
                cursor, testValues);

        // Finally, close the cursor and database
        cursor.close();
        assertTrue("Error: Cursor did not close", cursor.isClosed());
        db.close();
        assertFalse("Error: Database did not close", db.isOpen());
    }
