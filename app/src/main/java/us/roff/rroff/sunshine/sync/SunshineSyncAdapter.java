package us.roff.rroff.sunshine.sync;
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, Utility.getApiKey())
                    .build();
            ...
            if (buffer.length() == 0) {
                ...
                getWeatherDataFromJson(forecastJsonStr, locationQuery, provider);
            }
        } catch (IOException e) {
        ...
        if (Utility.isNotificationEnabled(context)) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // Create an artificial “backstack” so that when the user clicks the back button,
                    ...
                    mNotificationManager.notify(WEATHER_NOTIFICATION_ID, notifyBuilder.build());
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon,
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                Uri insertedUri = provider.insert(
                        WeatherContract.LocationEntry.CONTENT_URI,
                        locationValues);
